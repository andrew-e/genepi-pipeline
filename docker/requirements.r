...
install.packages(c("devtools", "MendelianRandomization", "eeptools", "gmp", "qqman", "corrplot", "broom", "conflicted", "nloptr", "Cairo", "plotrix", "forestplot"), repos = "http://cran.us.r-project.org")
